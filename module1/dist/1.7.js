...
{ // spread operator 
    ...
    const bros1 = ['rakib', 'shisir', 'yasin', 'rabbi'];
    const bros2 = ['jalaliset', 'pathao', 'jack'];
    bros1.push(...bros2);
    const mentors1 = {
        typescript: 'Mezba',
        redux: 'Mir',
    ...
    const { id, name: { firstName: prothomName }, // firstName to give  prothomName it's call Alice 
    contactNumber } = user;
    // array destructuring 
